...
✴️ Como parte del Capstone Project, presentarás un proyecto que formará parte de la evaluación final vía Zoom, en el que reforzarás y aplicarás los conocimientos adquiridos durante el entrenamiento. Toda la informacion relacionada con el proyecto final, esta disponibl en [ESTE](https://github.com/wizelineacademy/GEPP-IntroToAzure-2022/files/9930834/Intro.to.Azure.-.Capstone.Project.pdf) enlace.
